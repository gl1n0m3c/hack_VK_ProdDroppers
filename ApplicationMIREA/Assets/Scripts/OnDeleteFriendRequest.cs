...
public class OnDeleteFriendRequest : MonoBehaviour
{
    ...
    async public void OnClick()
    {
        ...
        try
        {
            ...
            {
                id1_vk = vkId,
                id2_vk = Convert.ToInt32(_recipientUser.text),
            }),
            Encoding.UTF8,
            "application/json");
            HttpResponseMessage response = await httpClient.PostAsync(WebUtils.BaseURL + "friends/delete/", jsonContent);
