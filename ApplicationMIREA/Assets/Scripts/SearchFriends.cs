...
public class SearchFriends : MonoBehaviour
{
    ...
    */
    ...
    async public void FetchFriendsByQuery()
    {
        ...
        try
        {
            ...
            HttpResponseMessage response = await httpClient.GetAsync(WebUtils.BaseURL + "users/friends/" + vkId + "/?page=" + _page + "&" + "start=" + query);
